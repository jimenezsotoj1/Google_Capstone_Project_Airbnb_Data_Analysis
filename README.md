...
By looking at the comment’s visualization (see table 4), at first glance, I can see that some of the largest adjectives are: great, clean, comfortable, cozy, perfect, and many more. Most of the high-frequency texts shown are overwhelmingly positive adjectives one would hope to find when looking for honest feedback on an Airbnb.
